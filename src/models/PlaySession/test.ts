...
import { PlaySession, Players, PlayerCardState, InvalidPlayerNumberError } from "./index.ts";
  ...
  describe("when player number is incorrect", () => {
    describe("initializeRandomPlayersCardState", () => {
      it("should throw an error", () => {
        ...
        expect(() => playSession.initializeRandomPlayersCardState())
          .toThrow(InvalidPlayerNumberError);
      });
    });
  });
